      ...
      <div class="tile-body">
        <form class="form-horizontal">
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input class="form-control col-md-7" type="text" placeholder="Items Category Name" id="name" value="<?php echo $data_category->items_category_name; ?>">
              <input class="form-control col-md-7" type="hidden" placeholder="Project Name" id="items_category_id" value="<?php echo $data_category->items_category_id; ?>">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-2">Info</label>
            <div class="col-md-8">
              <input class="form-control col-md-12" type="text" placeholder="Info" id="info" value="<?php echo $data_category->remarks; ?>">
            </div>
          </div>
        </form>
      </div>
  ...
  function(e){
    ...
    $.ajax({
      ...
      data: {
        name      : $('#name').val(),
        info      : $('#info').val(),
        items_category_id : $('#items_category_id').val()
      },
