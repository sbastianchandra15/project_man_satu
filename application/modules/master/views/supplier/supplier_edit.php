        ...
        <form class="form-horizontal">
          <div class="form-group row">
            ...
            <div class="col-md-2">
              <select class="form-control" id='supplier_kind_id'>
                ...
                foreach ($kind_supplier as $key => $value) {
                  if($value->supplier_kind_id==$new_supplier['supplier_kind_id']){
                    echo '<option value="'.$value->supplier_kind_id.'" selected>'.$value->kind_name.'</option>';
                  }else{
            ...
            <div class="col-md-5">
              ...
              <input type="hidden" id="supplier_id" value="<?php echo isset($new_supplier['supplier_id']) ? $new_supplier['supplier_id']:''; ?>" required />
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-md-4">
              <input class="form-control" type="file" id="file_npwp" name="file_npwp" value="<?php echo isset($new_supplier['file_npwp']) ? $new_supplier['file_npwp']:''; ?>">
            </div>
