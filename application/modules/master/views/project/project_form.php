<div class="app-title">
  <div>
    ...
    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>welcome">Home</a></li>
        ...
        <li class="breadcrumb-item active">Input Project</li>
  </ul></p>
  </div>
      ...
      <div class="tile-body">
        <form class="form-horizontal">
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input class="form-control col-md-7" type="text" placeholder="Project Name" id="name">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-2">Location</label>
            <div class="col-md-8">
              <input class="form-control col-md-8" type="text" placeholder="Location" id="location">
            </div>
          </div>
          <div class="form-group row">
...
$('#save').click(
  function(e){
    ...
    $.ajax({
      url: baseUrl+'master/project/form_act',
      type : "POST",  
      data: {
        name      : $('#name').val(),
