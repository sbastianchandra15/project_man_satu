      ...
      <div class="tile-body">
        <!-- <form class="form-horizontal"> -->
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input class="form-control col-md-3" type="text" placeholder="NIP User" id="nip" value="<?php echo $data_user->nip; ?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input class="form-control col-md-5" type="text" placeholder="Name User" id="name" value="<?php echo $data_user->name; ?>">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input class="form-control col-md-5" type="text" placeholder="Email Users" id="email" value="<?php echo $data_user->email ?>">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-md-2">
              <select class="form-control" id="user_level">
                ...
                foreach ($user_level as $key => $value) {
                  if($value->user_level_name==$data_user->user_level){
                    echo '<option value="'.$value->user_level_name.'" selected>'.$value->user_level_name.'</option>';
                  }else{
            ...
            <div class="col-md-2">
              <select class="form-control" id="id_user_level">
                ...
                foreach ($approve_level as $key => $value) {
                  ...
                  if($value->id_user_level==$data_user->id_user_level){
                    echo '<option value="'.$value->id_user_level.'" selected>'.$nama.'</option>';
                  }else{
            ...
            <div class="col-md-2">
              <select class="form-control" id="users_group">
                ...
                foreach ($user_group as $key => $value) {
                  if($value->id_user_group==$data_user->user_group){
          ...
          <div class="form-group row">
            ...
            <div class="col-md-3">
              <div class="animated-checkbox">
                <label><input type="checkbox" <?php echo ($value->user_id)? 'checked=""':''; ?> id="id_user_group" name="id_user_group" class="checkbox" value="<?php echo $value->id_user_group; ?>"/><span class="label-text"><?php echo $value->name; ?></span></label>
              </div>
            </div>
            <?php 
            }
...
$('#save').click(
  function(e){
    ...
    if(!$('#user_level').val()){
      $.notify({
        title: "Erorr : ",
        message: "<strong>Users Level</strong> Can't Be Empty",
        icon: 'fa fa-times' 
      },{
        type: "danger",
        delay: 1000
