<div class="app-title">
  <div>
    <h1>Input Warehouse</h1>
    <p><ul class="app-breadcrumb breadcrumb">
    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>welcome">Home</a></li>
        <li class="breadcrumb-item">Master</li>
        <li class="breadcrumb-item">Warehouse</li>
        <li class="breadcrumb-item active">Input Warehouse</li>
  </ul></p>
  </div>
      ...
      <div class="tile-body">
        <form class="form-horizontal">
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input class="form-control col-md-5" type="text" placeholder="Warehouse Name" id="name">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-2">Address</label>
            <div class="col-md-8">
              <input class="form-control col-md-8" type="text" placeholder="Address" id="address">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-2">Telp</label>
            <div class="col-md-8">
              <input class="form-control col-md-4" type="text" placeholder="Telp" id="telp">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-2">City</label>
            <div class="col-md-8">
              <input class="form-control col-md-7" type="text" placeholder="City" id="city">
            </div>
          </div>
          <div class="form-group row">
...
$('#save').click(
  function(e){
    ...
    $.ajax({
      url: baseUrl+'master/warehouse/form_act',
      type : "POST",  
      data: {
        name      : $('#name').val(),
        address   : $('#address').val(),
